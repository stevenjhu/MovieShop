...
//API is gonna use JWT Authentication so that it can look at the incoming request and look for Token and if valid,
//it will get the claims into HttpContext
